...
namespace SmartDormitary.Services
{
    public class SensorsService : ISensorsService
    {
        ...
        {
            return await dormitaryContext.Sensors.Where(s => s.Id == sensorId).ToListAsync();
        }
        ...
        {
            return await dormitaryContext.Sensors.Where(s => s.User.Id == userId).ToListAsync();
        }
        ...
        {
            return await dormitaryContext.Sensors.Where(s => s.IsPublic).ToListAsync();
        }
    }
}