...
connection.on("sensorUpdateData",
    function(sensorId, measurementType, sensorValue, sensorTypeMinVal, sensorTypeMaxVal) {
        $.get("/Sensor/GetSensorById",
            ...
            function(response, status) {
                ...
                if (measurementType === "(true/false)") {
                    ...
                    staticZones = [
                        { strokeStyle: "#F03E3E", min: 0, max: sensorTypeMinVal * 1 }, // Red
                        {
                            strokeStyle: "#30B32D",
                            min: sensorTypeMinVal * 1,
                            max: sensorTypeMaxVal * 1
                        }, // Green
                        {
                            strokeStyle: "#F03E3E",
                            min: sensorTypeMaxVal * 1,
